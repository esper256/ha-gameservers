...
- Default world is **Mars2**. Public listing defaults to off.
- Blank server name becomes a stable `HAOS Stationeers ####` per install.

## 1.0.1

- Detect version and players from logs. OPEN WEB UI shows Idle / Players Active.

## 1.0.0

- First Stationeers dedicated-server app.
- UDP **27016** (game) and **27015** (Steam query). Folder world saves.
